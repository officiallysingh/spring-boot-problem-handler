...
final class Lists {
	...
	/**
	 * Returns the length of the longest trailing partial sublist of the target list
	 * within the specified source list, or 0 if there is no such occurrence. More
	 * formally, returns the length <tt>i</tt> such that
	 ...
	 *     of <tt>target</tt>.
	 * @param target the list to search for as a trailing partial sublist of
	 *     <tt>source</tt>.
	 ...
	 * @since 1.4
	 */
	static int lengthOfTrailingPartialSubList(final List<?> source,
			final List<?> target) {
