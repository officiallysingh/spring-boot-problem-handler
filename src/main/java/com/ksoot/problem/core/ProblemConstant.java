...
public class ProblemConstant {
	...
	public static final String CONSTRAINT_VIOLATION_CODE_CODE_PREFIX = CODE_CODE_PREFIX
			+ GeneralErrorKey.CONSTRAINT_VIOLATION;
	public static final String CONSTRAINT_VIOLATION_TITLE_CODE_PREFIX = TITLE_CODE_PREFIX
			+ GeneralErrorKey.CONSTRAINT_VIOLATION;
	public static final String CONSTRAINT_VIOLATION_DETAIL_CODE_PREFIX = DETAIL_CODE_PREFIX
			+ GeneralErrorKey.CONSTRAINT_VIOLATION;
	...
	private ProblemConstant() {
		throw new IllegalStateException(
				"Just a constants container, not supposed to be instantiated");
	}
}
