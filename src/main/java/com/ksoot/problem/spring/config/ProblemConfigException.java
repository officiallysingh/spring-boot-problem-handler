...
public class ProblemConfigException extends RuntimeException {
	...
	/**
	 * Constructs a new {@code ConfigurationRuntimeException} without specified detail
	 * message.
	 */
	...
	/**
	 * Constructs a new {@code ConfigurationRuntimeException} with specified detail
	 * message.
	 *
	...
	/**
	 * Constructs a new {@code ConfigurationRuntimeException} with specified detail
	 * message using {@link String#format(String, Object...)}.
	 *
	 * @param message the error message
	...
	/**
	 * Constructs a new {@code ConfigurationRuntimeException} with specified nested
	 * {@code Throwable}.
	 *
