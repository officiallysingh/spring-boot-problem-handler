...
public class ProblemMessageSourceResolver implements MessageSourceResolvable, Serializable {
  ...
  private ProblemMessageSourceResolver(final String[] codes, final String defaultMessage, Object[] arguments) {
    this.codes = codes;
  ...
  public static ProblemMessageSourceResolver of(final String prefix, final ObjectError objectError,
                                                final String defaultMessage) {
    return of(Arrays.stream(objectError.getCodes()).map(code -> prefix + ProblemConstant.DOT + code).toArray(String[]::new),
        defaultMessage);
  }
  ...
  public static ProblemMessageSourceResolver of(final String prefix, final ObjectError objectError) {
    return new ProblemMessageSourceResolver(
        Arrays.stream(objectError.getCodes()).map(code -> prefix + ProblemConstant.DOT + code).toArray(String[]::new),
  ...
  public static ProblemMessageSourceResolver of(final String prefix, final FieldError fieldError) {
    return new ProblemMessageSourceResolver(
        Arrays.stream(fieldError.getCodes()).map(code -> prefix + ProblemConstant.DOT + code).toArray(String[]::new),
        fieldError.getDefaultMessage(), null);
  }

  public static ProblemMessageSourceResolver of(final String prefix, final FieldError fieldError,
                                                final String defaultMessage) {
    return of(Arrays.stream(fieldError.getCodes()).map(code -> prefix + ProblemConstant.DOT + code).toArray(String[]::new),
        defaultMessage);
  }
  ...
  public static ProblemMessageSourceResolver of(final String prefix, final ConstraintViolation violation) {
    return of(prefix + ProblemConstant.DOT + violation.getPropertyPath().toString(), violation.getMessage());
  }

  @SuppressWarnings("rawtypes")
  public static ProblemMessageSourceResolver of(final String prefix, final ConstraintViolation violation,
                                                final String defaultMessage) {
    return of(prefix + ProblemConstant.DOT + violation.getPropertyPath().toString(), defaultMessage);
  }
