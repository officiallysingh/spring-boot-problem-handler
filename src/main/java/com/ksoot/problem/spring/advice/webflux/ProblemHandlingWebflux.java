...
/**
 * {@link ProblemHandlingWebflux} is a composite {@link BaseAdviceTrait} that combines all
...
public interface ProblemHandlingWebflux<R>
		...
		HttpAdviceTraits<ServerWebExchange, R>, IOAdviceTraits<ServerWebExchange, R>,
