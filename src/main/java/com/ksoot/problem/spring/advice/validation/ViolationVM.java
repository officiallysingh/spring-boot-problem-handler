...
public class ViolationVM {
	...
	public static ViolationVM of(final String code, final String detail,
	...
	public static ViolationVM of(final String code, final String detail,
			final String propertyPath, MessageSourceResolvable codeResolver,
	...
	public static ViolationVM of(final String code, final String message,
			final String propertyPath, MessageSourceResolvable messageResolver) {
		ViolationVM violationVM = new ViolationVM();
		violationVM.code = code;
