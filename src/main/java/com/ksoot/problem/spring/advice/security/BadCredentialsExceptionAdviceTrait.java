 ...
 */
public interface BadCredentialsExceptionAdviceTrait<T, R> extends AdviceTrait<T, R> {

  /**
   * Handles {@link BadCredentialsException} and converts it into a {@link Problem} response.
   *
   ...
   */
  @ExceptionHandler
  default R handleBadCredentialsException(
      final BadCredentialsException exception, final T request) {
    Problem problem =
        toProblem(
            exception,
