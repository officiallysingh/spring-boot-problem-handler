...
public interface DuplicateKeyExceptionAdviceTrait<T, R>
	...
	@ExceptionHandler
	default R handleDuplicateKeyException(final DuplicateKeyException exception,
			final T request) {
		...
		String codeCode = ProblemConstant.CODE_CODE_PREFIX
				+ GeneralErrorKey.DATA_INTEGRITY_VIOLATION + ProblemConstant.DOT
				+ constraintName;
		String titleCode = ProblemConstant.TITLE_CODE_PREFIX
				+ GeneralErrorKey.DATA_INTEGRITY_VIOLATION + ProblemConstant.DOT
				+ constraintName;
		String messageCode = ProblemConstant.DETAIL_CODE_PREFIX
				+ GeneralErrorKey.DATA_INTEGRITY_VIOLATION + ProblemConstant.DOT
				+ constraintName;
		...
		Problem problem = toProblem(exception,
				...
				ProblemMessageSourceResolver.of(messageCode,
						ProblemConstant.DB_CONSTRAINT_VIOLATION_DEFAULT_MESSAGE));
