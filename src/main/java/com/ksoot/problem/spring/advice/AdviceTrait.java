...
public interface AdviceTrait<T, R> extends BaseAdviceTrait {
	...
	default R create(final Throwable throwable, final T request, final HttpStatus status,
		...
		return errorResponseBuilder().buildResponse(throwable, request, status, headers,
				problem);
	}
	...
	default R toProblem(final Throwable throwable, final T request,
		...
		ProblemMessageSourceResolver defaultCodeResolver = ProblemMessageSourceResolver
				.of(ProblemConstant.CODE_CODE_PREFIX + defaultErrorKey, status.value());
		ProblemMessageSourceResolver defaultTitleResolver = ProblemMessageSourceResolver
				.of(ProblemConstant.TITLE_CODE_PREFIX + defaultErrorKey,
						status.getReasonPhrase());
		ProblemMessageSourceResolver defaultDetailResolver = ProblemMessageSourceResolver
				.of(ProblemConstant.DETAIL_CODE_PREFIX + defaultErrorKey,
