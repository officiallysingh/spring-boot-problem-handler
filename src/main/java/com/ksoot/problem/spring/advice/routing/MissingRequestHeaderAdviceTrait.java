...
public interface MissingRequestHeaderAdviceTrait<T, R>
	...
	default R handleMissingServletRequestParameter(
		...
		String errorKey = exception.getParameter().getContainingClass().getSimpleName()
				...
				+ ProblemConstant.DOT + exception.getHeaderName();

		String codeCode = ProblemConstant.CODE_CODE_PREFIX
				+ GeneralErrorKey.MISSING_REQUEST_HEADER + ProblemConstant.DOT + errorKey;
