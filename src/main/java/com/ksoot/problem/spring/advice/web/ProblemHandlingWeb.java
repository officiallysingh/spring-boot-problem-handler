...
/**
 * {@link ProblemHandlingWeb} is a composite {@link BaseAdviceTrait} that combines all
 * general built-in advice traits into a single interface that makes it easier to use:
 *
 * <pre><code>
 ...
 * </code></pre>
 *
 * <strong>Note:</strong> Future versions of this class will be extended with additional
 * traits.
 *
 ...
 */
public interface ProblemHandlingWeb<R> extends GeneralAdviceTraits<NativeWebRequest, R>,
		HttpAdviceTraits<NativeWebRequest, R>, IOAdviceTraits<NativeWebRequest, R>,
